...
; Date: 18-10-2022
; Version: 2
; Compatibilidade: POS em 64Bits (Rocky)
; ===========================
...
Paste(entry) {
    Loop, Parse, entry
    {
        if (A_LoopField = 0) {
          ...
          BDCRocky := "|<Numpad0BDCRocky>*180$10.00Q3wQlXa6MNVaCQkz1s02"
          Contador := 0

          if (ok:=FindText(X, Y, 393-150000, 279-150000, 393+150000, 279+150000, 0, 0, Rocky))
          {
            if Contador <> 1
            {
          ...
          Rocky := "|<NUMPAD1Rocky>*174$10.00C1sDVy6s3UC0s3UC0sDszU0U"
          ...
          BDCRocky := "|<Numpad2BDCRocky>*175$9.00sDXCEkC1UM61UTny04"
          Contador := 0
          ...
          Rocky := "|<NUMPAD3Rocky>*193$12.003kDsDwQQ8Q1s1s0w0AMCQQDw7s00U"
          ...
          BDCRocky := "|<Numpad5BDCRocky>*182$9.01wDlUQ3wDk60kCTVs04"
          Contador := 0
          ...
          BDCRocky := "|<Numpad6BDCRocky>*175$9.00830kA3wRn6Mn6TUs04"
          Contador := 0
          ...
          BDCRocky := "|<Numpad7BDCRocky>*179$12.0000DwDw0M0M0k0k1U1U3030600000U"
          Contador := 0
          ...
          BDCRocky := "|<Numpad8BDCRocky>*173$9.00sDX6MlyDX6Mn6Dks04"          
          Contador := 0
          ...
          BDCRocky := "|<Numpad9BDCRocky>*180$10.00C3wAtlXCDsD0M3UQ1U02"
          Contador := 0
    ...
    if (ok:=FindText(X, Y, 650-150000, 175-150000, 650+150000, 175+150000, 0, 0, EntraRocky))
    {
      if Contador <> 1 
      {
        FindText().Click(X, Y, "L")
...
if (ok:=FindText(X, Y, 71-150000, 538-150000, 71+150000, 538+150000, 0, 0, LeiaDaRocky))
{
    EntraRocky:="|<EntraRocky>*124$34.zU0U03w0600A1MyYQkDvvzvwtaC1jn6Mk6kANX3z0laANzv6QlbzgMv7y"
...
*::
#IfWinActive, POS	; This code is only going to work if POS window is active.
Rocky:="|<MultRocky>*125$21.000000000000000UE06600tk03g00D001s00D003w00tk06601ks0000000000000000000004"
Contador:=0

if (ok:=FindText(X, Y, 650-150000, 248-150000, 650+150000, 248+150000, 0, 0, Rocky))
{
  if Contador <> 1
  {
    FindText().Click(X, Y, "L")
...
BDCRocky:="|<AnulaBDCRocky>*143$40.zzzzzzzzbzzzztyTzzzzXzzzzzyDzzzzzsyM0M71Xta9WBaDaNaQyMyNaNn1XtaNb8aDaNa8aM2NaM61zzzzbzzzzzyTzzzzztzzzzzzzzy"
Contador := 0
...
#IfWinActive, POS	; This code is only going to work if POS window is active.
Rocky := "|<Numpad7Rocky>*168$10.zxzk60s30Q1UC0k70M3UA2"
BDCRocky := "|<Numpad7BDCRocky>*179$16.00000000000Dw0zk0600M0300A01U0600k0300M000000000002"
Contador := 0
...
BDCRocky:="|<EntraBDCRocky>*137$36.zzzzzzUDzzzzUDzjzzXzz7zzXs2023UMH62FUMnCDtXsnCT1XsnCQ9Xsn6QtU8nWS1kBvrTDzzzzzzU"
Contador := 0
...
BDCRocky:="|<BackSpaceBDCRocky>*152$41."
Contador := 0

if (ok:=FindText(X, Y, 643-150000, 419-150000, 643+150000, 419+150000, 0, 0, Rocky))
{
  if Contador <> 1
  {
    FindText().Click(X, Y, "L")
...
if (ok:=FindText(X, Y, 393-150000, 279-150000, 393+150000, 279+150000, 0, 0, BDCRocky))
{
  if Contador <> 1
  {
    FindText().Click(X, Y, "L")
...
;-------------------------------------------------------------------------------------------------------
;-------------------------------------------------------------------------------------------------------
EcraBDCRocky:="|<BDCRocky>*147$156."
EcraPERTORocky:="|<PERTORocky>*146$190."
;-------------------------------------------------------------------------------------------------------
;-------------------------------------------------------------------------------------------------------



if ((ok:=FindText(X, Y, 1961-150000, 73-150000, 1961+150000, 73+150000, 0, 0, EcraBDCRocky)) or (ok:=FindText(X, Y, 1961-150000, 73-150000, 1961+150000, 73+150000, 0, 0, EcraPERTORocky)))
{
  space::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<spaceBDCRocky>*174$57.0000000003yD7sA0w7kTnwzXkTlz30s6AS72QQM70lnsk71nwS6An60k6TVszaNk60n03btza0kCM0AkDws71n0na1VraQQTrskM6Tlz1yC410Es3U0000000004"
  Contador := 0
  ...
  q::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<QBDCRocky>*173$13.003y3zVUtkAk6M3C1XVkzkDs0A03008"
  Contador := 0
  ...
  w::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<WBDCRocky>*173$17.000ksNlllXX3Da7PQCqkD7USD0wQ0kM000U"
  ...
  e::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<EBDCRocky>*168$9.03yM30M3wT30M3yTk0U"
  Contador := 0
  ...
  r::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<RBDCRocky>*172$10.01z7QMtX7wTVa6AMtVU0U"
  Contador := 0
  ...
  t::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<TBDCRocky>*188$11.00Tlzlz0s1k3U70C0Q0s1k01"
  Contador := 0
  ...
  y::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<YBDCRocky>*174$11.00ktlVa3w3k3U60A0M0k00U"
  Contador := 0
  ...
  u::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<UBDCRocky>*181$12.00QCQCQCQCQCQCQAAQDw7k00U"
  Contador := 0
  ...
  i::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<IBDCRocky>*189$5.0FnbCQtnbC1"
  Contador := 0
  ...
  o::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<OBDCRocky>*176$13.003y3zXUlUQkCM7A3b3VzUDU00U"
  Contador := 0
  ...
  p::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<PBDCRocky>*178$10.01z7CQNlbCTlw70Q1k00U"
  Contador := 0
  ...
  a::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<ABDCRocky>*173$12.003U3U3k6k6MCMDwTwMAM600U"
  Contador := 0
  ...
  s::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<SBDCRocky>*176$9.01wTX0Q1s7UC0nyTU0U"
  ...
  d::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<DBDCRocky>*177$21.0000000000000000007y00ts073U0sA071U0sA073U0sQ07z00zU0000000000000000000004"
  ...
  f::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<FBDCRocky>*171$9.03yTX0M3wTX0M30M00U"
  Contador := 0
  ...
  g::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<GBDCRocky>*174$21.0000000000000000000000Dk03z00s006001ls06700kM07300Ts00y0000000000000000004"
  Contador := 0
  ...
  h::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<HBDCRocky>*178$21.0000000000000000000003Uk0Q603Uk0QC03zk0Ty03Uk0Q603Uk0A60000000000000000004"
  Contador := 0
  ...
  j::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<JBDCRocky>*166$21.0000000000000003000M003000M003000M003000s00S003U00000000000000000000000004"
  Contador := 0
  ...
  k::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<KBDCRocky>*180$11.00stlXb7QDkTUvVnXXb300U"
  Contador := 0
  ...
  l::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<LBDCRocky>*181$21.0000000000000000000s007000s007000s007000s007000zU07w0000000000000000000004"
  Contador := 0
  ...
  z::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<ZBDCRocky>*178$11.00Tszk70A0s3U60M1k7z7w01"
  Contador := 0
  ...
  x::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<XBDCRocky>*177$11.00kNlVr1w3k3UDUvVX67A601"
  Contador := 0
  ...
  c::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<CBDCRocky>*177$11.003kTlkX060Q0M0s1tVz0s01"
  Contador := 0
  ...
  v::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<VBDCRocky>*177$12.00M6MAQAAQAMCM6k7k3k3U1000U"
  Contador := 0
  ...
  b::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<BBDCRocky>*175$10.01y7wMtX7wTlXa6Mtz7k02"
  Contador := 0
  ...
  n::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<NBDCRocky>*183$12.00A6Q6S6T6TaRaQyQSQSQC8400U"
  Contador := 0
  ...
  m::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  BDCRocky:="|<MBDCRocky>*171$21.000000000000000000M3U3UQ0S7U3kw0PBU3PA0NtU3CA0MlU30A0000000000000000000004"
  Contador := 0
