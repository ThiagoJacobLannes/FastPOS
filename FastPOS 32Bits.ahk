...
; Date: 21-10-2022
; Version: 2
; Compatibilidade: POS em 32Bits (Slack)
; ===========================
...
If (A_ScreenDPI <> 96) {
Percent := Chr(37)
MsgBox, Altere a escala do seu monitor para 100%Percent%.
return
}

SysGet, MonitorWorkArea, MonitorWorkArea, %A_Index%
If (MonitorWorkAreaRight < 1366)  {
  MsgBox, Resolução do ecrã não é compatível com o script.
return
}
...
Paste(entry) {
    Loop, Parse, entry
    {
        if (A_LoopField = 0) {
          ...
          EcraBDCPadrao:="|<BDC>*149$128."
          EcraPERTOPadrao:="|<PERTOPadrao>*146$191."
          Contador := 0
          ...
          else if (ok:=FindText(X, Y, 461-150000, 338-150000, 461+150000, 338+150000, 0, 0, EcraBDCPadrao))
          {
          ...
          else if (ok:=FindText(X, Y, 461-150000, 338-150000, 461+150000, 338+150000, 0, 0, EcraPERTOPadrao))
          {
            if (ok:=FindText(X, Y, 393-150000, 279-150000, 393+150000, 279+150000, 0, 0, PERTO))
            {
              if Contador <> 1
              {
                FindText().Click(X, Y, "L")
...
Gui, Add, Button, Default, OK
ButtonOK:
InputBox, OutputString, Digite o código, Prompt, , 100, 100, width/2, height/2, Locale, Timeout, %Clipboard%
...
Gui, Add, Button, Default, OK
ButtonOKDa:
InputBox, OutputDa, Digite o código Dá, Prompt, , 250, 100, width/2, height/2, Locale, Timeout,
...
if (ok:=FindText(X, Y, 71-150000, 538-150000, 71+150000, 538+150000, 0, 0, LeiaDaPadrao))
{
    EntraPadrao:="|<Entra>*120$36.000000Ds0800Ds0A00A1MSoMA3yyzyDnaQsaDn6Qk6A36QkyA36QlyDv6ClyDv6Cly000000U"
    Contador:=0
...
*::
#IfWinActive, POS	; This code is only going to work if POS window is active.
Padrao:="|<NUMPADX>*121$11.00E8kln1i1s3k7UPVn37A601"
Contador:=0
...
BDC:="|<AnulaBDCPadrao>*146$41.zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzyzzzzznxzzzzzbzzzzzzDzzzzzyTY4A3Uwz80MX9tyHAHbnnwaQbC7btAtCED7mNm1US1YnY30zzzztzzzzzznzzzzzzbzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"
PERTO:="|<AnulaPERTOPadrao>*146$41.zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzxzzzzzbvzzzzzDzzzzzyTzzzzzwz88M71tyE0l6HnwaMbDbbtAtCQDDmNmQUSDYnY30w39b861zzzznzzzzzzbzzzzzzDzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"
...
else if (ok:=FindText(X, Y, 393-150000, 279-150000, 393+150000, 279+150000, 0, 0, BDC))
{
  if Contador <> 1
  {
    FindText().Click(X, Y, "L")
...
BDC := "|<EntraBDCPadrao>*140$41.zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzy0zzzzzw1zwzzzszztzzzly1U11zUQ3263z0tbATXyDn6Nw7wTaAnUDszANb4Tk6MkC0zkBvrTTzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzw"
PERTO:="|<EntraPERTOPadrao>*143$71."
...
BDC:="|<BackSpaceBDCPadrao>*150$41."
PERTO:="|<BackspacePERTOPadrao>*151$41.zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzDzzzzzwTzzzzzkzzzzzz3zzzzzwDzzzzzkzzzzzz0007zzy000Dzzy7zzzzzy7zzzzzy7zzzzzy7zzzzzyDzzzzzyTzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"
...
if (ok:=FindText(X, Y, 1961-150000, 73-150000, 1961+150000, 73+150000, 0, 0, EcraBDCPadrao) or (ok:=FindText(X, Y, 1961-150000, 73-150000, 1961+150000, 73+150000, 0, 0, EcraPERTOPadrao)))
{
  space::
  #IfWinActive, POS	; This code is only going to work if POS window is active.
  EcraBDCPadrao:="|<BDC>*149$128."
  ...
  BDC:="|<spaceBDCPadrao>*175$71."
  PERTO:="|<spacePERTOPadrao>*175$67."
  
  Contador := 0
  
  if (ok:=FindText(X, Y, 461-150000, 338-150000, 461+150000, 338+150000, 0, 0, EcraBDCPadrao))
  {
    if (ok:=FindText(X, Y, 461-150000, 338-150000, 461+150000, 338+150000, 0, 0, BDC))
    {
      if Contador <> 1
  ...
  BDC:="|<QBDCPadrao>*173$21.000000000000000TU07z01kM0A3U1UA0A1U1UQ06700zk01y000s003U000000000000000004"
  PERTO:="|<QPERTOPadrao>*173$21.000000000000000TU07z01kM0A3U1UA0A1U1UQ06700zk01y000s003U000000000000000004"
  Contador := 0
  ...
  BDC:="|<WBDCPadrao>*171$21.000000000000000000ksM7770Msk3Da0Rgk1hg0D7U1sw07700kM0000000000000000000004"
  PERTO:="|<WPERTOPadrao>*171$21.000000000000006730sss3760Nwk3ha0BhU1sw0D7U0ss06300000000000000000000000004"
  ...
  BDC:="|<EBDCPadrao>*176$21.000000000000000zU07w00s007000z007s00s007000zU07w00000000000000000000000004"
  PERTO:="|<EPERTOPadrao>*176$21.0000000000000000003y00Tk03U00Q003w00TU03U00Q003y00Tk0000000000000000000004"
  ...
  BDC:="|<RBDCPadrao>*168$21.0000000000000000000000TU03y00Mk03600TU03s00NU03C00Mk0370000000000000000004"
  PERTO:="|<RPERTOPadrao>*168$21.000000000000000TU03y00Mk03600TU03s00NU03C00Mk03700000000000000000000000004"
  Contador := 0
  ...
  BDC:="|<TBDCPadrao>*167$21.0000000000000000007y00zk00k006000k006000k006000k00600000000000000000000004"
  PERTO:="|<TPERTOPadrao>*167$21.000000000000000zk07y006000k006000k006000k006000k00000000000000000000000004"
  ...
  BDC:="|<YBDCPadrao>*175$21.0000000000000000007300Ms03a00Bk00w007000M003000M00300000000000000000000004"
  PERTO:="|<YPERTOPadrao>*175$21.0000000000000000007300Ms03a00Bk00w007000M003000M00300000000000000000000004"
  ...
  BDC:="|<UBDCPadrao>*178$21.000000000000000sM07300sM07300sM07300sM03700Ts01y00000000000000000000000004"
  PERTO:="|<UPERTOPadrao>*178$21.0000000000000000000001kk0C601kk0C601kk0C601kk06C00zk03w0000000000000000004"
  ...
  BDC:="|<IBDCPadrao>*172$31.000000000000000000000000000000000000000000000000000000k0000M0000A000060000300001U0000k0000M0000A0000600000000000000000000000000000000000000000000000000000000000E"
  PERTO:="|<IPERTOPadrao>*171$21.0000000000000000000k006000k006000k006000k006000k00600000000000000000000004"
  ...
  BDC:="|<OBDCPadrao>*178$21.00000000000000000000000001y00zs073U1kQ0C1U1kA0C3U0sM03z00Dk000000000000004"
  PERTO:="|<OPERTOPadrao>*178$21.0000000000000000001y00zs073U1kQ0C1U1kA0C3U0sM03z00Dk0000000000000000000004"
  ...
  BDC:="|<PBDCPadrao>*169$21.0000000000000000003w00Tk03600Mk03600Tk03s00M003000M00000000000000000000004"
  PERTO:="|<PPERTOPadrao>*169$21.0000000000000000001y00Ds01X00AM01X00Ds01w00A001U00A00000000000000000000004"
  ...
  BDC:="|<ABDCPadrao>*171$21.00000000000000000000000000s007001s00BU01g00Mk03y00zs06301kM000000000000004"
  PERTO:="|<APERTOPadrao>*171$21.0000000000000000000000C001k00S003M00P006A00zU0Dy01Uk0Q60000000000000000004"
  ...
  BDC:="|<SBDCPadrao>*177$21.000000000000000DU03w00M003000T000w001k00600Tk03w00000000000000000000000004"
  PERTO:="|<SPERTOPadrao>*177$21.0000000000000000000000DU03w00M003000T000w001k00600Tk03w0000000000000000004"
  ...
  BDC:="|<DBDCPadrao>*168$21.0000000000000000007s00zk06700kM06300kM06300ks07C00zU0000000000000000000004"
  PERTO:="|<DPERTOPadrao>*168$21.0000000000000000000000z007y00ks06300kM06300kM06700tk07w0000000000000000004"
  ...
  BDC:="|<FBDCPadrao>*167$21.000000000000000Dk01y00A001U00DU01y00A001U00A001U00000000000000000000000004"
  PERTO:="|<FPERTOPadrao>*167$21.000000000000000TU03w00M003000T003w00M003000M003000000000000000000000000004"
  ...
  BDC:="|<GBDCPadrao>*176$21.000000000000000T007y01kU0A003U00QS01Xk0C600zk03w00000000000000000000000004"
  PERTO:="|<GPERTOPadrao>*176$21.0000000000000000001w00Ts07200k00C001ls06D00sM03z00Dk0000000000000000000004"
  Contador := 0
  ...
  BDC:="|<HBDCPadrao>*182$21.0000000000000000007300sQ073U0sQ07zU0zw073U0sQ073U0sQ0000000000000000000004"
  PERTO:="|<HPERTOPadrao>*182$21.0000000000000000007300sQ073U0sQ07zU0zw073U0sQ073U0sQ0000000000000000000004"
  ...
  BDC:="|<JBDCPadrao>*169$21.0000000000000000000M003000M003000M003000M003000s00S00000000000000000000004"
  PERTO:="|<JPERTOPadrao>*169$21.000000000000A001U00A001U00A001U00A001U00Q00D000000000000000000000000000004"
  ...
  BDC:="|<KBDCPadrao>*181$21.0000000000000000007700sk07C00vU07s00z007Q00tk07C00ss0000000000000000000004"
  PERTO:="|<KPERTOPadrao>*181$21.0000000000000000000000QQ03X00Qs03i00TU03w00Rk03b00Qs03XU000000000000000004"
  ...
  BDC:="|<LBDCPadrao>*189$21.0000000000000000001k00C001k00C001k00C001k00C001y00Ds00y0000000000000000004"
  PERTO:="|<LPERTOPadrao>*189$21.0000000000000000001k00C001k00C001k00C001k00C001y00Ds00y0000000000000000004"
  ...
  BDC:="|<ZBDCPadrao>*175$21.0000000000000000007y00zk00Q003000k00C001U00M007000zk07w0000000000000000004"
  PERTO:="|<ZPERTOPadrao>*175$21.000000000000000Ts03z001k00A003000s006001U00Q003z00Tk0000000000000000000004"
  ...
  BDC:="|<XBDCPadrao>*177$21.000000000006300sk03C00DU01s007001w00RU03C00ks06300000000000000000000000004"
  PERTO:="|<XPERTOPadrao>*177$21.00000000000000000031U0QM01b007k00w003U00y00Ck01b00MQ031U000000000000000004"
  ...
  BDC:="|<CBDCPadrao>*177$21.000000000000000D003y00sU0C001U00A001U00C000sk03y00D00000000000000000000004"
  PERTO:="|<CPERTOPadrao>*177$21.0000000000000007U01z00QE07000k006000k007000QM01z007U0000000000000000000004"
  ...
  BDC:="|<VBDCPadrao>*180$21.000000000000001UM0A701kk06C00tU03A00PU03s00D001k00600000000000000000000004"
  PERTO:="|<VPERTOPadrao>*180$21.00000000000000000061U0kQ07300Ms03a00Ak01i00DU00w007000M0000000000000000004"
  ...
  BDC:="|<BBDCPadrao>*175$21.0000000000000000003w00Tk03700Ms03y00Tk03b00MM03700Tk03w0000000000000000004"
  PERTO:="|<BPERTOPadrao>*175$21.000000000000000TU03y00Ms03700Tk03y00Qs03300Ms03y00TU0000000000000000000004"
  ...
  BDC:="|<NBDCPadrao>*184$21.000000000000001UE0C701ss0Db01ws0Br01bs0AT01Vs0A701UE0000000000000000000004"
  PERTO:="|<NPERTOPadrao>*184$21.000000000000000k8073U0wQ07nU0yQ06vU0nw06DU0kw063U0k80000000000000000000004"
  ...
  BDC:="|<MBDCPadrao>*176$21.000000000000001UA0C3U1kQ0D7U1sw0BhU1jg0AtU1bA0A1U1040000000000000000000004"
  PERTO:="|<MPERTOPadrao>*176$21.000000000000000k6071k0sC07Xk0wS06qk0rq06Qk0na060k0U20000000000000000000004"
